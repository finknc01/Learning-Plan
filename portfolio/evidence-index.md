...
|---|---|---|---|
| [Phoenix-Node](https://github.com/finknc01/Phoenix-Node) | RHEL/GPU node administration, troubleshooting, and rebuild | Planned | inventory, service/SELinux incident, storage/network fault, GPU validation, automation, rebuild report |
...
1. a RHEL incident report with a clear evidence chain;
