...
GitHub intentionally does not maintain a second live status or “current sprint” tracker.

## Portfolio projects

| Project | Engineering story |
|---|---|
| [Phoenix-Node](https://github.com/finknc01/Phoenix-Node) | Build, break, diagnose, automate, and rebuild a GPU-ready RHEL node |
| [Topology-Faultline](https://github.com/finknc01/Topology-Faultline) | Diagnose performance differences caused by NUMA/PCIe/device locality |
| [Fabric-Faultline](https://github.com/finknc01/Fabric-Faultline) | Trace and repair increasingly difficult AI-cluster network failures |
| [Scheduler-Colosseum](https://github.com/finknc01/Scheduler-Colosseum) | Compare Docker, Kubernetes, and Slurm execution models using the same workload |
| [Blackbox-GPU](https://github.com/finknc01/Blackbox-GPU) | Reconstruct GPU incidents from telemetry, logs, and timelines |
| [Private-AI-Foundry](https://github.com/finknc01/Private-AI-Foundry) | Design defensible infrastructure for sensitive/private AI workloads |
| [Atlas-Rack](https://github.com/finknc01/Atlas-Rack) | Design an AI rack under power, cooling, cabling, and failure constraints |
| [Lazarus-Cluster](https://github.com/finknc01/Lazarus-Cluster) | Destroy cluster dependencies and prove recovery from source-controlled truth |
| [Silicon-Tetris](https://github.com/finknc01/Silicon-Tetris) | Model GPU, VRAM, power, network, storage, budget, and growth constraints |
| [Checkpoint-Rush](https://github.com/finknc01/Checkpoint-Rush) | Prove when storage behavior is starving expensive compute |
...
| Weeks | Focus |
|---|---|
| 1–6 | RHEL administration, storage, host networking, troubleshooting, Bash |
...
A finished task or project should eventually point to something demonstrable. Useful evidence includes:
...
- **Week 6:** production-style RHEL administration
